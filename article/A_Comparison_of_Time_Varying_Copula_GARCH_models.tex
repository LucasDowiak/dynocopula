...
\begin{equation} \label{eq:conditional_var}
    h_{t} = \omega + \sum_{j=1}^{m} \alpha_{j} \emph{A}(\varepsilon^{2}_{t - j}) + \sum_{i=1}^{k} \beta_{i} \emph{B}(h_{t - i})
\end{equation}
...
The value $m$ is set to the largest lag and the weight term, $(m - j + 1) / m$, decreases as the length of the lag increases. In the equation above, $\hat{r}_{j}(x)$ is used to denote the sample correlation value of the series $x$ at the k$^{th}$ lag.
...
\begin{table}
	...
	\begin{tabular}{l l l l | l l l}
		...
		\midrule
         ...
         shape         &  1.683$^{**}$    & 1.551$^{**}$ & 1.230$^{**}$ & 0.989$^{**}$ & 0.852$^{**}$ & 0.456$^{**}$ \\ \\
...
\begin{table}
	...
	\begin{tabular}[c]{l c r r r | r r r | r r r}
		...
		Pound-Yen   & 1 &           -365.1 &  -309.4 &  -273.5 &           -365.1 &  -309.4 &  -273.5 &            -365.1 &  -309.4 &   -273.4  \\
				    ...
				    & 4 &           -406.8 &  -274.2 &  -298.5 &           -473.2 &  -397.1 &    80.8 &   \textbf{-511.1} &  -418.0 &   -387.5  \\
		\hline
	\end{tabular}
	\begin{tablenotes}
...
\begin{table}
	...
	\begin{tabular}[c]{l c r r r | r r r | r r r}
		\midrule
		         &        & \multicolumn{3}{c}{\underline{Markov Switching}} & \multicolumn{3}{c}{\underline{Smooth Trans.}} & \multicolumn{3}{c}{\underline{Seq. Break}} \\
